...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://tomasz-piotrowicz.github.io/";
    ...
    private boolean checkTaskExistInTrello(String taskName) throws InterruptedException{
        ...
        driverTrello.findElement(By.id("user")).sendKeys("tomasz.piotrowicz2@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("trampek1");
