...
public class BookDirectoryTestSuite {
    ...
    @Test
    public void testListBooksInHandsOfWithoutAnyBook() {
        //Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser user1 = new LibraryUser("Jan", "Kowalski", "123456");
    ...
    @Test
    public void ListBooksInHandsOfWithOneBook(){
        //Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser user1 = new LibraryUser("Jan", "Kowalski", "123456");
        ...
        Book book1 = new Book("Secrets of Alamo", "John Smith", 2008);
        listOf1Books.add(book1);
        when(libraryDatabaseMock.listBooksInHandsOf(user1)).thenReturn(listOf1Books);
        //When
    ...
    @Test
    public void ListBooksInHandsOfWithTenBooks(){
        //Given
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser user1 = new LibraryUser("Jan", "Kowalski", "123456");
        List<Book> listOf10Books = generateListOfNBooks(10);
        when(libraryDatabaseMock.listBooksInHandsOf(user1)).thenReturn(listOf10Books);
        //When
        List<Book> theListOf10Books = bookLibrary.listBooksInHandsOf(user1);
        //Then
        assertEquals(10, theListOf10Books.size());
    }
